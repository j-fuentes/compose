...
class Project(object):
    ...
    def pull(self, service_names=None, ignore_pull_failures=False, insecure_registry=False, default_registry=None, out_stream=None):
        for service in self.get_services(service_names, include_deps=True):
            if out_stream:
                service.pull(ignore_pull_failures=ignore_pull_failures, insecure_registry=insecure_registry, default_registry=default_registry, out_stream=out_stream)
            else:
                service.pull(ignore_pull_failures=ignore_pull_failures, insecure_registry=insecure_registry, default_registry=default_registry)
